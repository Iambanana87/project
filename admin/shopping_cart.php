...
<section class="products">
   ...
   <form action="" method="POST" class="box">
      ...
      <p class="sub-total">Tổng giá sản phẩm : <span><i class="fa-solid fa-coins"></i><?= $sub_total = ($fetch_cart['qty'] * $fetch_cart['price']); ?></span></p>
   ...
   <?php if($grand_total != 0){ ?>
      <div class="cart-total">
         <p>Tổng hóa đơn : <span><i class="fa-solid fa-coins"></i><?= $grand_total; ?></span></p>
